...
if __name__ == "__main__":
    ...
    databases = ['INCART', 'mitdb']
    
    # Destino a donde guardar los datos procesados
    processed_files_directory = '/home/augusto/Desktop/GIBIO/processed_dbs/only_MLII_beta'
    ...
    valid_window_time = 50e-3 # Margen de tolerancia de la anotacion
    channels = ['MLII', 'II', 'ML2']
    
    for this_database in databases:
        print('Procesando database: ' + this_database)
        ...
        for this_record in recording_names:
            ...
            data['beat_slices'], data['no_beat_slices'], data['data'], data['fields'] = data_generation_utils.make_train_set(database_directory + this_database + os.sep + this_record, slice_time, valid_window_time, target_freq, return_intervals = True, channels = channels, pre_processing = pre_function)
